...
//             if (
//                 ((a.anyid = a.anyid === undefined ? [] : a.anyid), -1 != jQuery.inArray(b.attr("id"), a.anyid))
//             ) {
...
//                         ),
//                         console.log(" "),
//                         (b.modulesfailing = !0), !1) :
//                     (jQuery.ajax({
//                             url: b.jsFileLocation +
//                                 a +
//                                 b.extensions_suffix +
//                                 "?version=" +
//                                 version.core,
...
//             jQuery("body").data(
//                     "rs-fullScreenMode", !jQuery("body").data("rs-fullScreenMode")
//                 ),
...
//                         })),
//                     setCurWinRange(b),
//                     setCurWinRange(b, !0), !a.hasClass("revslider-initialised"))
//             ) {
...
//                     setCurWinRange(b),
//                     setCurWinRange(b, !0), !_R.resizeThumbsTabs || !0 === _R.resizeThumbsTabs(b))
//             ) {
//                 if (
...
//                                     (h = h == undefined || "auto" == h || "" == h ? f.height : h), !jQuery.isNumeric(g) && g.indexOf("%") > 0 && (h = g),
//                                     c.data("ww", g),
//                                     c.data("hh", h);
//                             }
//                         else
...
//                 d.removeClass("next-revslide").addClass("processing-revslide"), -1 === d.index() &&
//                 "carousel" === b.sliderType &&
//                 (d = jQuery(b.li[0])),
//                 d.data(
